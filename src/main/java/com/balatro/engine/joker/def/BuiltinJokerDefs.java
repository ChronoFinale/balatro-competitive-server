...
public final class BuiltinJokerDefs {
    ...
    private static JokerDef suitMult(String key, String name, Suit suit) {
        ...
        return Jokers.common(key, name).cost(5)
    ...
    private static JokerDef typeMult(String key, String name, HandType part, int mult) {
        return Jokers.common(key, name).cost(4)
    ...
    private static JokerDef typeXMult(String key, String name, HandType part, double xmult) {
        return Jokers.rare(key, name).cost(8)
    ...
    private static JokerDef gem(String key, String name, Suit suit, Op op, int amount) {
        ...
        return Jokers.uncommon(key, name).cost(7)
    ...
    public static List<JokerDef> all() {
        return List.of(
                ...
                Jokers.common("j_ride_the_bus", "Ride the Bus").cost(6)
                ...
                Jokers.common("j_square", "Square Joker").cost(4)
                ...
                Jokers.common("j_scholar", "Scholar").cost(4)
                ...
                // --- per-card mult ---
                Jokers.common("j_smiley", "Smiley Face").cost(4)
                ...
                Jokers.common("j_walkie_talkie", "Walkie Talkie").cost(4)
                ...
                Jokers.uncommon("j_fibonacci", "Fibonacci").cost(8)
                ...
                Jokers.common("j_shoot_the_moon", "Shoot the Moon").cost(5)
                ...
                Jokers.rare("j_baron", "Baron").cost(8)
                ...
                Jokers.common("j_runner", "Runner").cost(5)
                ...
                Jokers.rare("j_wee", "Wee Joker").cost(8)
                ...
                Jokers.uncommon("j_trousers", "Spare Trousers").cost(6)
                ...
                Jokers.uncommon("j_steel_joker", "Steel Joker").cost(7)
                ...
                Jokers.uncommon("j_hiker", "Hiker").cost(5)
                ...
                Jokers.uncommon("j_midas_mask", "Midas Mask").cost(7)
                ...
                Jokers.uncommon("j_vampire", "Vampire").cost(7)
                ...
                Jokers.common("j_gros_michel", "Gros Michel").cost(5)
                ...
                Jokers.common("j_cavendish", "Cavendish").cost(4)
                ...
                Jokers.legendary("j_triboulet", "Triboulet").cost(20)
                ...
                Jokers.uncommon("j_flower_pot", "Flower Pot").cost(6)
                ...
                Jokers.uncommon("j_seeing_double", "Seeing Double").cost(6)
                ...
                Jokers.common("j_golden_ticket", "Golden Ticket").cost(5)
                ...
                Jokers.common("j_photograph", "Photograph").cost(5)
                        .desc("The first scored face card gives x2 Mult")
                        .forEachScored(card().firstFace()).multiply(MULT, 2).build(),
                Jokers.rare("j_drivers_license", "Driver's License").cost(7)
                        ...
                        .multiply(MULT, 3).build(),
                Jokers.uncommon("j_blackboard", "Blackboard").cost(6)
                ...
                Jokers.uncommon("j_pareidolia", "Pareidolia").cost(5)
                        .desc("All cards are considered face cards").handMod(HandMod.PAREIDOLIA).build(),
                Jokers.common("j_splash", "Splash").cost(3)
                ...
                Jokers.common("j_green_joker", "Green Joker").cost(4)
                ...
                Jokers.common("j_fortune_teller", "Fortune Teller").cost(6)
                ...
                modJoker("j_juggler", "Juggler", "+1 hand size", "Common", 4,
                        Modify.add(Value.Var.HAND_SIZE, 1)),
                modJoker("j_drunkard", "Drunkard", "+1 discard each round", "Common", 4,
                        Modify.add(Value.Var.DISCARDS_LEFT, 1)),
                modJoker("j_troubadour", "Troubadour", "+2 hand size, -1 hand each round", "Uncommon", 6,
                        Modify.add(Value.Var.HANDS_LEFT, -1), Modify.add(Value.Var.HAND_SIZE, 2)),
                modJoker("j_merry_andy", "Merry Andy", "+3 discards, -1 hand size", "Uncommon", 7,
                        Modify.add(Value.Var.DISCARDS_LEFT, 3), Modify.add(Value.Var.HAND_SIZE, -1)),
                Jokers.uncommon("j_burglar", "Burglar").cost(6)
                        .desc("+3 hands this round, but no discards")
                        .mods(Modify.add(Value.Var.HANDS_LEFT, 3)).runMod(RunMod.locksDiscards()).build(),
                Jokers.rare("j_stuntman", "Stuntman").cost(7)
                ...
                Jokers.common("j_raised_fist", "Raised Fist").cost(5)
                ...
                Jokers.common("j_delayed_gratification", "Delayed Gratification").cost(4)
                ...
                Jokers.common("j_8_ball", "8 Ball").cost(5)
                ...
                Jokers.common("j_superposition", "Superposition").cost(4)
                        ...
                        .create(CreateSpec.Kind.TAROT).build(),
                Jokers.uncommon("j_seance", "Seance").cost(6)
                ...
                Jokers.uncommon("j_marble", "Marble Joker").cost(6)
                ...
                Jokers.common("j_riff_raff", "Riff-Raff").cost(6)
                ...
                Jokers.uncommon("j_sixth_sense", "Sixth Sense").cost(6)
                ...
                Jokers.uncommon("j_space", "Space Joker").cost(5)
                ...
                Jokers.uncommon("j_glass_joker", "Glass Joker").cost(6)
                ...
                Jokers.rare("j_hit_the_road", "Hit the Road").cost(8)
                ...
                Jokers.rare("j_burnt", "Burnt Joker").cost(8)
                ...
                Jokers.common("j_ice_cream", "Ice Cream").cost(5)
                        ...
                        .effect(new Effect.DestroySelf()).build(),
                Jokers.common("j_popcorn", "Popcorn").cost(5)
                ...
                Jokers.uncommon("j_matador", "Matador").cost(7)
                ...
                Jokers.uncommon("j_diet_cola", "Diet Cola").cost(6)
                ...
                Jokers.common("j_hallucination", "Hallucination").cost(4)
                        ...
                        .create(CreateSpec.Kind.TAROT).build(),
                Jokers.common("j_red_card", "Red Card").cost(5)
                ...
                Jokers.uncommon("j_showman", "Showman").cost(5)
                ...
                Jokers.common("j_pizza", "Pizza").cost(4)
                ...
                Jokers.uncommon("j_speedrun", "Speedrun").cost(6)
                ...
                Jokers.common("j_penny_pincher", "Penny Pincher").cost(4)
                ...
                Jokers.uncommon("j_skip_off", "Skip-Off").cost(5)
                        .desc("+1 Hand and +1 Discard per additional blind skipped vs your Nemesis")
                        .runMod(RunMod.skipBonus()).build(),
                Jokers.uncommon("j_lets_go_gambling", "Let's Go Gambling").cost(6)
                ...
                Jokers.common("j_pacifist", "Pacifist").cost(4)
                        .desc("x10 Mult while not in a PvP blind")
                        .whenHand(not(Cond.inPvpBlind())).multiply(MULT, 10).build(),
                Jokers.common("j_defensive_joker", "Defensive Joker").cost(4)
                ...
                Jokers.uncommon("j_conjoined", "Conjoined Joker").cost(6)
                ...
                Jokers.common("j_taxes", "Taxes").cost(5)
                ...
                Jokers.uncommon("j_throwback", "Throwback").cost(6)
                ...
                Jokers.uncommon("j_turtle_bean", "Turtle Bean").cost(6)
                ...
                Jokers.rare("j_obelisk", "Obelisk").cost(8)
                ...
                Jokers.uncommon("j_loyalty_card", "Loyalty Card").cost(5)
                ...
                Jokers.uncommon("j_trading", "Trading Card").cost(6)
                ...
                Jokers.uncommon("j_luchador", "Luchador").cost(5)
                ...
                Jokers.uncommon("j_ceremonial", "Ceremonial Dagger").cost(6)
                ...
                Jokers.uncommon("j_madness", "Madness").cost(7)
                ...
                Jokers.uncommon("j_satellite", "Satellite").cost(6)
                ...
                Jokers.uncommon("j_oops", "Oops! All 6s").cost(4)
                        .desc("Doubles all listed probabilities")
                        .runMod(RunMod.probabilityDoubler()).build(),
                Jokers.common("j_reserved_parking", "Reserved Parking").cost(6)
                ...
                runModJoker("j_mr_bones", "Mr. Bones",
                        ...
                        "Uncommon", 5, RunMod.survivesLostBlind(0.25)),
                Jokers.uncommon("j_to_the_moon", "To the Moon").cost(5)
                ...
                Jokers.common("j_mail_in_rebate", "Mail-In Rebate").cost(4)
                ...
                Jokers.uncommon("j_castle", "Castle").cost(6)
                        ...
                        .whenHand(state("chips").atLeast(1)).add(CHIPS, Val.state("chips")).build(),
                Jokers.common("j_todo_list", "To Do List").cost(4)
                ...
                Jokers.uncommon("j_idol", "The Idol").cost(6)
                ...
                Jokers.rare("j_ancient_joker", "Ancient Joker").cost(8)
                ...
                Jokers.rare("j_baseball_card", "Baseball Card").cost(8)
                ...
                Jokers.common("j_swashbuckler", "Swashbuckler").cost(4)
                ...
                Jokers.common("j_supernova", "Supernova").cost(5)
                ...
                Jokers.uncommon("j_card_sharp", "Card Sharp").cost(6)
                ...
                Jokers.uncommon("j_lucky_cat", "Lucky Cat").cost(6)
                ...
                Jokers.rare("j_campfire", "Campfire").cost(9)
                ...
                Jokers.uncommon("j_ramen", "Ramen").cost(6)
    ...
    private static JokerDef runModJoker(String key, String name, String desc, String rarity,
            int cost, RunMod mod) {
        return builderFor(rarity, key, name).cost(cost).desc(desc).runMod(mod).build();
    }
    ...
    private static JokerDef modJoker(String key, String name, String desc, String rarity,
            int cost, Modify... mods) {
        return builderFor(rarity, key, name).cost(cost).desc(desc).mods(mods).build();
    }
