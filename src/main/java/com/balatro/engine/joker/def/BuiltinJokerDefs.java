...
public final class BuiltinJokerDefs {
    ...
    public static java.util.Map<String, List<JokerDef>> variants() {
        return java.util.Map.of("multiplayer", List.of(
                ...
                Jokers.common("j_hanging_chad", "Hanging Chad").cost(4).atlas(9, 6)
    ...
    public static List<JokerDef> all() {
        return List.of(
                ...
                Jokers.rare("j_brainstorm", "Brainstorm").cost(10).atlas(7, 7)
                ...
                Jokers.common("j_gros_michel", "Gros Michel").cost(5).atlas(7, 6)
                ...
                Jokers.common("j_cavendish", "Cavendish").cost(4).atlas(5, 11)
                ...
                Jokers.uncommon("j_flower_pot", "Flower Pot").cost(6).atlas(0, 6)
                ...
                Jokers.uncommon("j_seeing_double", "Seeing Double").cost(6).atlas(4, 4)
                ...
                Jokers.uncommon("j_four_fingers", "Four Fingers").cost(7).atlas(6, 6)
                ...
                Jokers.uncommon("j_mime", "Mime").cost(5).atlas(4, 1)
                        .desc("Retrigger all cards held in hand")
                        .on(Trigger.REPETITION_HELD).retrigger().build(),
                Jokers.uncommon("j_dusk", "Dusk").cost(5).atlas(4, 7)
                ...
                Jokers.common("j_photograph", "Photograph").cost(5).atlas(2, 13)
                        .desc("The first scored face card gives x2 Mult")
                        .forEachScored(card().firstFace()).multiply(MULT, 2).build(),
                Jokers.rare("j_drivers_license", "Driver's License").cost(7).atlas(0, 7)
                        ...
                        .multiply(MULT, 3).build(),
                Jokers.uncommon("j_blackboard", "Blackboard").cost(6).atlas(2, 10)
                ...
                Jokers.uncommon("j_pareidolia", "Pareidolia").cost(5).atlas(6, 3)
                        .desc("All cards are considered face cards").handMod(HandMod.PAREIDOLIA).build(),
                Jokers.common("j_splash", "Splash").cost(3).atlas(6, 10)
                ...
                Jokers.common("j_green_joker", "Green Joker").cost(4).atlas(2, 11)
                ...
                Jokers.common("j_fortune_teller", "Fortune Teller").cost(6).atlas(7, 5)
                ...
                Jokers.uncommon("j_erosion", "Erosion").cost(6).atlas(5, 13)
                ...
                modJoker("j_juggler", "Juggler", "+1 hand size", "Common", 4, 0, 1,
                        Modify.add(Value.Var.HAND_SIZE, 1)),
                modJoker("j_drunkard", "Drunkard", "+1 discard each round", "Common", 4, 1, 1,
                        Modify.add(Value.Var.DISCARDS_LEFT, 1)),
                modJoker("j_troubadour", "Troubadour", "+2 hand size, -1 hand each round", "Uncommon", 6, 0, 2,
                        Modify.add(Value.Var.HANDS_LEFT, -1), Modify.add(Value.Var.HAND_SIZE, 2)),
                modJoker("j_merry_andy", "Merry Andy", "+3 discards, -1 hand size", "Uncommon", 7, 8, 0,
                        Modify.add(Value.Var.DISCARDS_LEFT, 3), Modify.add(Value.Var.HAND_SIZE, -1)),
                Jokers.uncommon("j_burglar", "Burglar").cost(6).atlas(1, 10)
                        .desc("+3 hands this round, but no discards")
                        .mods(Modify.add(Value.Var.HANDS_LEFT, 3)).runMod(RunMod.locksDiscards()).build(),
                Jokers.rare("j_stuntman", "Stuntman").cost(7).atlas(8, 6)
                ...
                Jokers.common("j_raised_fist", "Raised Fist").cost(5).atlas(8, 2)
                ...
                Jokers.common("j_8_ball", "8 Ball").cost(5).atlas(0, 5)
                ...
                Jokers.common("j_superposition", "Superposition").cost(4).atlas(3, 11)
                        ...
                        .create(CreateSpec.Kind.TAROT).build(),
                Jokers.uncommon("j_seance", "Seance").cost(6).atlas(0, 12)
                ...
                Jokers.uncommon("j_marble", "Marble Joker").cost(6).atlas(3, 2)
                ...
                Jokers.common("j_riff_raff", "Riff-Raff").cost(6).atlas(1, 12)
                ...
                Jokers.uncommon("j_sixth_sense", "Sixth Sense").cost(6).atlas(8, 10)
                ...
                Jokers.uncommon("j_space", "Space Joker").cost(5).atlas(3, 5)
                ...
                Jokers.legendary("j_canio", "Canio").cost(20).atlas(6, 15)
                        ...
                        .whenHand().multiply(MULT, Val.state("x", 1.0, 1.0)).build(),
                Jokers.legendary("j_yorick", "Yorick").cost(20).atlas(5, 9)
                ...
                Jokers.rare("j_hit_the_road", "Hit the Road").cost(8).atlas(8, 5)
                ...
                Jokers.rare("j_burnt", "Burnt Joker").cost(8).atlas(3, 7)
                ...
                Jokers.rare("j_dna", "DNA").cost(8).atlas(5, 10)
                ...
                Jokers.common("j_ice_cream", "Ice Cream").cost(5).atlas(4, 10)
                        ...
                        .effect(new Effect.DestroySelf()).build(),
                Jokers.common("j_popcorn", "Popcorn").cost(5).atlas(1, 15)
                ...
                Jokers.uncommon("j_matador", "Matador").cost(7).atlas(4, 5)
                ...
                Jokers.uncommon("j_diet_cola", "Diet Cola").cost(6).atlas(8, 14)
                ...
                Jokers.common("j_hallucination", "Hallucination").cost(4).atlas(9, 13)
                        ...
                        .create(CreateSpec.Kind.TAROT).build(),
                Jokers.common("j_red_card", "Red Card").cost(5).atlas(7, 11)
                ...
                Jokers.uncommon("j_throwback", "Throwback").cost(6).atlas(5, 7)
                ...
                Jokers.rare("j_obelisk", "Obelisk").cost(8).atlas(9, 12)
                ...
                Jokers.uncommon("j_loyalty_card", "Loyalty Card").cost(5).atlas(4, 2)
                ...
                Jokers.uncommon("j_trading", "Trading Card").cost(6).atlas(9, 14)
                ...
                Jokers.uncommon("j_luchador", "Luchador").cost(5).atlas(1, 13)
                ...
                Jokers.uncommon("j_ceremonial", "Ceremonial Dagger").cost(6).atlas(5, 5)
                ...
                Jokers.uncommon("j_madness", "Madness").cost(7).atlas(8, 11)
                ...
                Jokers.uncommon("j_satellite", "Satellite").cost(6).atlas(8, 7)
                ...
                Jokers.uncommon("j_oops", "Oops! All 6s").cost(4).atlas(5, 6)
                        .desc("Doubles all listed probabilities")
                        .runMod(RunMod.probabilityDoubler()).build(),
                Jokers.common("j_reserved_parking", "Reserved Parking").cost(6).atlas(6, 13)
                ...
                runModJoker("j_chicot", "Chicot", "Disables the effect of every Boss Blind",
                        "Legendary", 20, 6, 9, RunMod.bossDisabler()),
                ...
                Jokers.common("j_credit_card", "Credit Card").cost(1).atlas(5, 1)
                        .desc("Go up to -$20 in debt").mods(Modify.min(Value.Var.MIN_MONEY, -20)).build(),
                Jokers.common("j_chaos", "Chaos the Clown").cost(4).atlas(1, 0)
                        .desc("1 free reroll each shop")
                        .mods(Modify.add(Value.Var.FREE_REROLLS, 1)).build(),
                Jokers.uncommon("j_astronomer", "Astronomer").cost(8).atlas(2, 7)
                ...
                runModJoker("j_mr_bones", "Mr. Bones",
                        ...
                        "Uncommon", 5, 3, 4, RunMod.survivesLostBlind(0.25)),
                Jokers.uncommon("j_to_the_moon", "To the Moon").cost(5).atlas(8, 13)
                ...
                Jokers.uncommon("j_castle", "Castle").cost(6).atlas(9, 15)
                        ...
                        .whenHand(state("chips").atLeast(1)).add(CHIPS, Val.state("chips")).build(),
                Jokers.common("j_todo_list", "To Do List").cost(4).atlas(4, 11)
                ...
                Jokers.uncommon("j_idol", "The Idol").cost(6).atlas(6, 7)
                ...
                Jokers.common("j_supernova", "Supernova").cost(5).atlas(2, 4)
                ...
                Jokers.uncommon("j_card_sharp", "Card Sharp").cost(6).atlas(6, 11)
                ...
                Jokers.uncommon("j_lucky_cat", "Lucky Cat").cost(6).atlas(5, 14)
                ...
                Jokers.rare("j_campfire", "Campfire").cost(9).atlas(5, 15)
                ...
                Jokers.uncommon("j_ramen", "Ramen").cost(6).atlas(2, 15)
