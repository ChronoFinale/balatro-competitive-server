...
public final class RngSources {
    ...
    /** The Wheel: per-drawn-card roll deciding whether the card arrives face down. */
    public static final RngSource BOSS_FACE_DOWN = RngSource.of("boss:face_down").perBlind().composition();
    /** The Hook: pick which held cards to discard after each played hand. */
    public static final RngSource BOSS_HOOK = RngSource.of("boss:hook").perBlind().composition();
    /** Crimson Heart: pick which Joker is disabled for each played hand. */
    public static final RngSource BOSS_CRIMSON = RngSource.of("boss:crimson").perBlind().composition();
    /** Amber Acorn: shuffle the Joker order at blind start. */
    public static final RngSource BOSS_ACORN = RngSource.of("boss:acorn").perBlind().composition();
    /** Cerulean Bell: pick which held card is force-selected. */
    public static final RngSource BOSS_BELL = RngSource.of("boss:bell").perBlind().composition();
