 ...
 * values); antes beyond 8 use the formula in {@link com.balatro.engine.game.Blinds}.
...
public record Ruleset(
    ...
    /** The behavioural capability set for this ruleset's mode (Glass mult, idol/duplicate/ouija modes,
     *  pool variants). The engine reads capabilities, never the {@code jokerVariant} label.
     *  {@code @JsonIgnore}: derived from {@code jokerVariant}, not a serialized property. */
    @com.fasterxml.jackson.annotation.JsonIgnore
    public Capabilities capabilities() {
        return Capabilities.of(jokerVariant);
    }
