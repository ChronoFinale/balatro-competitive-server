...
/** 22 discriminators the server dispatches on — the client must handle exactly these. */
...
/** 11 discriminators the server dispatches on — the client must handle exactly these. */
